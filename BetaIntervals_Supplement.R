...
load("T2_models_thin_5000_samples_250_chains_4.Rdata")
m = models[[1]]
mpost = convertToCodaObject(m)
CIs = summary(mpost$Beta)
...
load("T3_models_thin_5000_samples_250_chains_4.Rdata")
m = models[[1]]
mpost = convertToCodaObject(m)
CIs = summary(mpost$Beta)
betatableT = data.frame(rownames(CIs[[1]]),CIs[[1]][, 1], CIs[[2]][, c(3, 1, 5)])
...
load("T4_models_thin_5000_samples_250_chains_4.Rdata")
m = models[[1]]
mpost = convertToCodaObject(m)
CIs = summary(mpost$Beta)
betatableT = data.frame(rownames(CIs[[1]]),CIs[[1]][, 1], CIs[[2]][, c(3, 1, 5)])
